...
function draw3DAxis() {
    ...
    for (let i = 0; i <= axisLengthX; i += 10) {
        if (i % 50 === 0) {
            ...
            axisContext.fillText((i / scale).toFixed(0), originX + i - 10, originY - 10);
        } else {
            axisContext.fillStyle = 'red';
    ...
    for (let i = 0; i <= axisLengthY; i += 10) {
        ...
        if (i % 50 === 0) {
            ...
            axisContext.fillText((i / scale).toFixed(0), x + 5, y + 15);
        } else {
            axisContext.fillStyle = 'green';
            axisContext.fillRect(x - 1, y - 1, 2, 2);
        }
    ...
    for (let i = 0; i <= axisLengthZ; i += 10) {
        if (i % 50 === 0) {
            ...
            axisContext.fillText((i / scale).toFixed(0), originX - 30, originY - i + 5);
        } else {
            axisContext.fillStyle = 'blue';
